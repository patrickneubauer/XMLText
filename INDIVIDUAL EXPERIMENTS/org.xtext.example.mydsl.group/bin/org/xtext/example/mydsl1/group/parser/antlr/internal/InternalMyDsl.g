...
entryRuleElement1Choice returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getElement1ChoiceRule()); }
	 iv_ruleElement1Choice=ruleElement1Choice 
	 { $current=$iv_ruleElement1Choice.current; } 
	 EOF 
;

// Rule Element1Choice
ruleElement1Choice returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
