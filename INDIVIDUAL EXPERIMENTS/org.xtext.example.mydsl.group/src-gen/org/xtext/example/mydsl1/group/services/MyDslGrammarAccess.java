...
* generated by Xtext
*/
package org.xtext.example.mydsl1.group.services;
...
public class MyDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class Element1Elements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cElement1ChoiceKeyword_3_0 = (Keyword)cGroup_3.eContents().get(0);
		private final Assignment cElement1ChoiceAssignment_3_1 = (Assignment)cGroup_3.eContents().get(1);
		private final RuleCall cElement1ChoiceElement1ChoiceParserRuleCall_3_1_0 = (RuleCall)cElement1ChoiceAssignment_3_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_4 = (Keyword)cGroup.eContents().get(4);
		
		//Element1:
		//	{Element1} "Element1" "{" ("element1Choice" element1Choice=Element1Choice)? "}";
		public ParserRule getRule() { return rule; }
		...
		//("element1Choice" element1Choice=Element1Choice)?
		public Group getGroup_3() { return cGroup_3; }

		//"element1Choice"
		public Keyword getElement1ChoiceKeyword_3_0() { return cElement1ChoiceKeyword_3_0; }

		//element1Choice=Element1Choice
		public Assignment getElement1ChoiceAssignment_3_1() { return cElement1ChoiceAssignment_3_1; }

		//Element1Choice
		public RuleCall getElement1ChoiceElement1ChoiceParserRuleCall_3_1_0() { return cElement1ChoiceElement1ChoiceParserRuleCall_3_1_0; }
	...
	public class Element1ChoiceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "Element1Choice");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cElement1ChoiceAction_0 = (Action)cGroup.eContents().get(0);
		private final Keyword cElement1ChoiceKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Keyword cLeftCurlyBracketKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Group cGroup_3 = (Group)cGroup.eContents().get(3);
		private final Keyword cRepeatableElement1Keyword_3_0 = (Keyword)cGroup_3.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_3_1 = (Keyword)cGroup_3.eContents().get(1);
		...
		private final Assignment cRepeatableElement2Assignment_4_2 = (Assignment)cGroup_4.eContents().get(2);
		private final RuleCall cRepeatableElement2String0ParserRuleCall_4_2_0 = (RuleCall)cRepeatableElement2Assignment_4_2.eContents().get(0);
		private final Group cGroup_4_3 = (Group)cGroup_4.eContents().get(3);
		private final Keyword cCommaKeyword_4_3_0 = (Keyword)cGroup_4_3.eContents().get(0);
		private final Assignment cRepeatableElement2Assignment_4_3_1 = (Assignment)cGroup_4_3.eContents().get(1);
		private final RuleCall cRepeatableElement2String0ParserRuleCall_4_3_1_0 = (RuleCall)cRepeatableElement2Assignment_4_3_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_4_4 = (Keyword)cGroup_4.eContents().get(4);
		private final Group cGroup_5 = (Group)cGroup.eContents().get(5);
		private final Keyword cRepeatableElement3Keyword_5_0 = (Keyword)cGroup_5.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_5_1 = (Keyword)cGroup_5.eContents().get(1);
		private final Assignment cRepeatableElement3Assignment_5_2 = (Assignment)cGroup_5.eContents().get(2);
		private final RuleCall cRepeatableElement3String0ParserRuleCall_5_2_0 = (RuleCall)cRepeatableElement3Assignment_5_2.eContents().get(0);
		private final Group cGroup_5_3 = (Group)cGroup_5.eContents().get(3);
		private final Keyword cCommaKeyword_5_3_0 = (Keyword)cGroup_5_3.eContents().get(0);
		private final Assignment cRepeatableElement3Assignment_5_3_1 = (Assignment)cGroup_5_3.eContents().get(1);
		private final RuleCall cRepeatableElement3String0ParserRuleCall_5_3_1_0 = (RuleCall)cRepeatableElement3Assignment_5_3_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_5_4 = (Keyword)cGroup_5.eContents().get(4);
		private final Keyword cRightCurlyBracketKeyword_6 = (Keyword)cGroup.eContents().get(6);
		
		//Element1Choice:
		//	{Element1Choice} "Element1Choice" "{" ("repeatableElement1" "{" repeatableElement1+=String0 (","
		//	repeatableElement1+=String0)* "}")? ("repeatableElement2" "{" repeatableElement2+=String0 (","
		//	repeatableElement2+=String0)* "}")? ("repeatableElement3" "{" repeatableElement3+=String0 (","
		//	repeatableElement3+=String0)* "}")? "}";
		public ParserRule getRule() { return rule; }
		...
		//{Element1Choice}
		public Action getElement1ChoiceAction_0() { return cElement1ChoiceAction_0; }

		//"Element1Choice"
		public Keyword getElement1ChoiceKeyword_1() { return cElement1ChoiceKeyword_1; }
		...
		//("repeatableElement2" "{" repeatableElement2+=String0 ("," repeatableElement2+=String0)* "}")?
		public Group getGroup_4() { return cGroup_4; }
		...
		//repeatableElement2+=String0
		public Assignment getRepeatableElement2Assignment_4_2() { return cRepeatableElement2Assignment_4_2; }

		//String0
		public RuleCall getRepeatableElement2String0ParserRuleCall_4_2_0() { return cRepeatableElement2String0ParserRuleCall_4_2_0; }
		...
		//repeatableElement2+=String0
		public Assignment getRepeatableElement2Assignment_4_3_1() { return cRepeatableElement2Assignment_4_3_1; }

		//String0
		public RuleCall getRepeatableElement2String0ParserRuleCall_4_3_1_0() { return cRepeatableElement2String0ParserRuleCall_4_3_1_0; }

		//"}"
		public Keyword getRightCurlyBracketKeyword_4_4() { return cRightCurlyBracketKeyword_4_4; }

		//("repeatableElement3" "{" repeatableElement3+=String0 ("," repeatableElement3+=String0)* "}")?
		public Group getGroup_5() { return cGroup_5; }
		...
		//repeatableElement3+=String0
		public Assignment getRepeatableElement3Assignment_5_2() { return cRepeatableElement3Assignment_5_2; }

		//String0
		public RuleCall getRepeatableElement3String0ParserRuleCall_5_2_0() { return cRepeatableElement3String0ParserRuleCall_5_2_0; }
		...
		//repeatableElement3+=String0
		public Assignment getRepeatableElement3Assignment_5_3_1() { return cRepeatableElement3Assignment_5_3_1; }

		//String0
		public RuleCall getRepeatableElement3String0ParserRuleCall_5_3_1_0() { return cRepeatableElement3String0ParserRuleCall_5_3_1_0; }
	...
	private final Element1ChoiceElements pElement1Choice;
	...
	public MyDslGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pElement1Choice = new Element1ChoiceElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.example.mydsl1.group.MyDsl".equals(grammar.getName())) {
				return grammar;
			}
	...
	//	repeatableElement2+=String0)* "}")? ("repeatableElement3" "{" repeatableElement3+=String0 (","
	//	repeatableElement3+=String0)* "}")? "}";
	public Element1ChoiceElements getElement1ChoiceAccess() {
		return pElement1Choice;
	}
	
	public ParserRule getElement1ChoiceRule() {
		return getElement1ChoiceAccess().getRule();
	}
