...
* generated by Xtext
*/
package org.xtext.example.mydsl.references.unchanged.services;
...
public class MyDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class OrderRef1Elements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cOrderDetail1IDREFParserRuleCall_3_1_0 = (RuleCall)cOrderDetail1Assignment_3_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_4 = (Keyword)cGroup.eContents().get(4);
		
		//OrderRef1:
		//	{OrderRef1} "OrderRef1" "{" ("orderDetail1" orderDetail1=IDREF)? "}";
		public ParserRule getRule() { return rule; }
		...
		//IDREF
		public RuleCall getOrderDetail1IDREFParserRuleCall_3_1_0() { return cOrderDetail1IDREFParserRuleCall_3_1_0; }
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.example.mydsl.references.unchanged.MyDsl".equals(grammar.getName())) {
				return grammar;
			}
