...
* generated by Xtext
*/
package org.xtext.example.mydsl.references.services;
...
public class MyDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class OrderRef1Elements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cOrderDetail1OrderDetail1CrossReference_3_1_0 = (CrossReference)cOrderDetail1Assignment_3_1.eContents().get(0);
		private final RuleCall cOrderDetail1OrderDetail1IDREFParserRuleCall_3_1_0_1 = (RuleCall)cOrderDetail1OrderDetail1CrossReference_3_1_0.eContents().get(1);
		private final Keyword cRightCurlyBracketKeyword_4 = (Keyword)cGroup.eContents().get(4);
		
		//OrderRef1:
		//	{OrderRef1} "OrderRef1" "{" ("orderDetail1" orderDetail1=[OrderDetail1|IDREF])? "}";
		public ParserRule getRule() { return rule; }
		...
		//[OrderDetail1|IDREF]
		public CrossReference getOrderDetail1OrderDetail1CrossReference_3_1_0() { return cOrderDetail1OrderDetail1CrossReference_3_1_0; }

		//IDREF
		public RuleCall getOrderDetail1OrderDetail1IDREFParserRuleCall_3_1_0_1() { return cOrderDetail1OrderDetail1IDREFParserRuleCall_3_1_0_1; }
	...
	public class OrderRef2Elements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cOrderDetail2OrderDetail2CrossReference_3_1_0 = (CrossReference)cOrderDetail2Assignment_3_1.eContents().get(0);
		private final RuleCall cOrderDetail2OrderDetail2IDREFParserRuleCall_3_1_0_1 = (RuleCall)cOrderDetail2OrderDetail2CrossReference_3_1_0.eContents().get(1);
		private final Keyword cRightCurlyBracketKeyword_4 = (Keyword)cGroup.eContents().get(4);
		
		//OrderRef2:
		//	{OrderRef2} "OrderRef2" "{" ("orderDetail2" orderDetail2=[OrderDetail2|IDREF])? "}";
		public ParserRule getRule() { return rule; }
		...
		//[OrderDetail2|IDREF]
		public CrossReference getOrderDetail2OrderDetail2CrossReference_3_1_0() { return cOrderDetail2OrderDetail2CrossReference_3_1_0; }

		//IDREF
		public RuleCall getOrderDetail2OrderDetail2IDREFParserRuleCall_3_1_0_1() { return cOrderDetail2OrderDetail2IDREFParserRuleCall_3_1_0_1; }
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.example.mydsl.references.MyDsl".equals(grammar.getName())) {
				return grammar;
			}
