/**
 */
package org.xtext.example.mydsl.recursion.myDsl.impl;
...
import org.xtext.example.mydsl.recursion.myDsl.Element;
import org.xtext.example.mydsl.recursion.myDsl.Model;
import org.xtext.example.mydsl.recursion.myDsl.MyDslFactory;
...
public class MyDslPackageImpl extends EPackageImpl implements MyDslPackage
{
   ...
   * @see org.xtext.example.mydsl.recursion.myDsl.MyDslPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public void initializePackageContents()
  {
    ...
    pairEClass.getESuperTypes().add(this.getElement());
    pairsEClass.getESuperTypes().add(this.getElement());
    ...
    initEReference(getPairs_Elements(), this.getElement(), null, "elements", null, 0, -1, Pairs.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
