...
* generated by Xtext
*/
package org.xtext.example.mydsl.references.untyped.ui.contentassist.antlr;
...
public class MyDslParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.example.mydsl.references.untyped.ui.contentassist.antlr.internal.InternalMyDslParser createParser() {
		org.xtext.example.mydsl.references.untyped.ui.contentassist.antlr.internal.InternalMyDslParser result = new org.xtext.example.mydsl.references.untyped.ui.contentassist.antlr.internal.InternalMyDslParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOrderRef1Access().getNameAssignment_3_1(), "rule__OrderRef1__NameAssignment_3_1");
					put(grammarAccess.getOrderRef2Access().getNameAssignment_3_1(), "rule__OrderRef2__NameAssignment_3_1");
				}
			};
		}
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.example.mydsl.references.untyped.ui.contentassist.antlr.internal.InternalMyDslParser typedParser = (org.xtext.example.mydsl.references.untyped.ui.contentassist.antlr.internal.InternalMyDslParser) parser;
