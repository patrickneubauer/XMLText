...
public class Library3Formatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private Library3GrammarAccess _library3GrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._library3GrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._library3GrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._library3GrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._library3GrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._library3GrammarAccess.getML_COMMENTRule();
