 ...
 * generated by Xtext
 */
package at.ac.tuwien.big.xaml.formatting;
...
public class XamlFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private XamlGrammarAccess _xamlGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._xamlGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._xamlGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._xamlGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._xamlGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._xamlGrammarAccess.getML_COMMENTRule();
