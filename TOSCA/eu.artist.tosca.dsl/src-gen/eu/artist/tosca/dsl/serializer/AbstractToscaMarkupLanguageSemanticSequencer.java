...
public abstract class AbstractToscaMarkupLanguageSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ToscaPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case ToscaPackage.EFEATURE_MAP_ENTRY_TYPE:
				if(context == grammarAccess.getEFeatureMapEntryTypeRule()) {
					sequence_EFeatureMapEntryType(context, (EFeatureMapEntryType) semanticObject); 
					return; 
				}
				else break;
			case ToscaPackage.EFEATURE_MAP_TYPE:
				if(context == grammarAccess.getEFeatureMapTypeRule()) {
					sequence_EFeatureMapType(context, (EFeatureMapType) semanticObject); 
					return; 
				}
				else break;
	...
	/**
	 * Constraint:
	 *     (name=QName value=STRING)
	 */
	protected void sequence_EFeatureMapEntryType(EObject context, EFeatureMapEntryType semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ToscaPackage.Literals.EFEATURE_MAP_ENTRY_TYPE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ToscaPackage.Literals.EFEATURE_MAP_ENTRY_TYPE__NAME));
			if(transientValues.isValueTransient(semanticObject, ToscaPackage.Literals.EFEATURE_MAP_ENTRY_TYPE__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ToscaPackage.Literals.EFEATURE_MAP_ENTRY_TYPE__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getEFeatureMapEntryTypeAccess().getNameQNameParserRuleCall_0_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getEFeatureMapEntryTypeAccess().getValueSTRINGTerminalRuleCall_2_0(), semanticObject.getValue());
		feeder.finish();
	}
	...
	/**
	 * Constraint:
	 *     (id=ID0 propertyKeyValuePair+=EFeatureMapEntryType*)
	 */
	protected void sequence_EFeatureMapType(EObject context, EFeatureMapType semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_PropertiesType(EObject context, PropertiesType semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ToscaPackage.Literals.PROPERTIES_TYPE__MAP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ToscaPackage.Literals.PROPERTIES_TYPE__MAP));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getPropertiesTypeAccess().getMapEFeatureMapTypeParserRuleCall_1_0(), semanticObject.getMap());
		feeder.finish();
	}
